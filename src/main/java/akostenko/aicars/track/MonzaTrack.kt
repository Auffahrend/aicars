...
class MonzaTrack : Track() {
    ...
    override val sections = TrackBuilder.start(0.0, 0.0, 0.0, width)
            .straight(900.0)
            // Retiffilo
            .right(12.0, 80.0).straight(22.0).left(11.0, 115.0)
            .straight(105.0)
            .right(82.0, 35.0)
            .straight(169.0)
            // Curva Grande
            ...
            .straight(150.0)
            // Lesmo 1
            .right(55.0, 90.0).right(60.0, 30.0)
            .straight(250.0)
            // Lesmo 2
            ...
            .straight(600.0)
            // Ascari
            .left(35.0, 45.0).straight(45.0).right(115.0, 50.0).left(40.0, 20.0).left(71.0, 20.0)
            .straight(961.0)
            // Parabolica
